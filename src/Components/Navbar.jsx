...
const Navbar = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="bg-[#CC313D] p-4 border-b-2 border-gray-200 fixed top-0 left-0 w-full z-50">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden flex flex-col space-y-2 mt-2 bg-[#CC313D] p-2 rounded">
            ...
            <button className="text-white text-center hover:bg-black transition-all duration-300 p-2 rounded">
              Cart
            </button>
            <Link
              to="/login"
      ...
      {/* Products Section */}
      <div id="products" className="bg-[#122F3D] text-white py-4 mt-[80px] fixed top-0 left-0 w-full z-50">
