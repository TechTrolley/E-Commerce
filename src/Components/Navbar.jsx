	...
	return (
		<>
					...
					<div className="flex items-center space-x-4">
						...
						<div className="relative hidden md:block">
							<input
								type="text"
								placeholder="Search..."
								className="pl-10 pr-9 py-2.5 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
							/>
							<svg
						...
						<button className="text-white hover:text-[#000000] transition-all duration-300 pl-1">
							<FaShoppingCart size={25} />
						</button>

						{/* Login Icon */}
						<button className="text-white hover:text-[#000000] transition-all duration-300  absolute right-0 pr-3">
							<FaUser size={25} />
						</button>
			...
			<div id="products" className="bg-[#122F3D] text-white py-4">
				<div className="max-w-screen-xl mx-auto flex flex-wrap justify-left space-x-4">
					<a
						href="#smartphones"
