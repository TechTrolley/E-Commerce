...
import { ShoppingBag } from "lucide-react"; // Importing icon
...
const Orders = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 mt-12 flex items-center justify-center">
        My Orders
        {orders.length === 0 && <ShoppingBag className="ml-3 text-gray-500" size={28} />}
      </h1>

      {orders.length === 0 ? (
        <p className="text-gray-600 mt-6 text-center">You have no orders yet.</p>
      ) : (
